...
const char* get_room_overview(int current_room) {
	switch (current_room) {
		case 1:
			return "You are in the Church of Elleh. Ruins surround you, and a Site of Grace flickers faintly.";
		case 2:
			return "You are on the Mistwood Outskirts. Howling echoes from the nearby forest.";
		case 3:
			return "You stand at the Siofra River Lift. The lift hums with ghostly energy.";
		case 4:
			return "You arrive at Blaidd's Watch. A half-wolf warrior peers into the sky.";
		case 5:
			return "You reach the Siofra River Depths. Spectral flames dance in the distance.";
		case 6:
			return "You enter Nokron, Eternal City. The ruins glow under an alien sky.";
		case 7:
			return "You are in the Hallowhorn Grounds. Spirit creatures drift between pillars.";
		case 8:
			return "You reach the Crater of Radahn's Fall. Meteoric debris surrounds you.";
		case 9:
			return "You walk through Deeproot Depths. Massive tree roots twist above.";
		case 10:
			return "You stand before the Prince of Death's Throne. The air is still, corrupted.";
		default:
